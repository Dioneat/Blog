...
namespace Blog10.Models
{
    public class AboutData
    {
        ...
        public string? HeroTag { get; set; } = "Елена Тимофеева • Опыт 12 лет";
        ...
        [MaxLength(200)]
        public string? HeroSubtitle { get; set; } = "Елена Тимофеева высшей категории";
        ...
        public string? HeroBadge1Text { get; set; } = "20+ счастливых семей";
        public string? HeroBadge2Text { get; set; } = "Сертифицированный эксперт";
    }
}